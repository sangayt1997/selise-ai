      ...
      typography: {
        DEFAULT: {
          css: {
            ...
            '--tw-prose-headings': 'hsl(var(--high-emphasis))',
            '--tw-prose-lead': 'hsl(var(--medium-emphasis))',
            '--tw-prose-links': 'hsl(var(--primary-500))',
            '--tw-prose-bold': 'hsl(var(--high-emphasis))',
            '--tw-prose-counters': 'hsl(var(--medium-emphasis))',
            '--tw-prose-bullets': 'hsl(var(--low-emphasis))',
            '--tw-prose-hr': 'hsl(var(--border))',
            '--tw-prose-quotes': 'hsl(var(--foreground))',
            '--tw-prose-quote-borders': 'hsl(var(--border))',
            '--tw-prose-captions': 'hsl(var(--medium-emphasis))',
            '--tw-prose-kbd': 'hsl(var(--high-emphasis))',
            '--tw-prose-kbd-shadows': 'hsl(var(--neutral-300))',
            '--tw-prose-code': 'hsl(var(--high-emphasis))',
            '--tw-prose-pre-code': 'hsl(var(--foreground))',
            '--tw-prose-pre-bg': 'hsl(var(--surface))',
            '--tw-prose-th-borders': 'hsl(var(--border))',
            '--tw-prose-td-borders': 'hsl(var(--border))',
            '--tw-prose-invert-body': 'hsl(var(--foreground))',
            '--tw-prose-invert-headings': 'hsl(var(--high-emphasis))',
            '--tw-prose-invert-lead': 'hsl(var(--medium-emphasis))',
            '--tw-prose-invert-links': 'hsl(var(--primary-500))',
            '--tw-prose-invert-bold': 'hsl(var(--high-emphasis))',
            '--tw-prose-invert-counters': 'hsl(var(--medium-emphasis))',
            '--tw-prose-invert-bullets': 'hsl(var(--low-emphasis))',
            '--tw-prose-invert-hr': 'hsl(var(--border))',
            '--tw-prose-invert-quotes': 'hsl(var(--foreground))',
            '--tw-prose-invert-quote-borders': 'hsl(var(--border))',
            '--tw-prose-invert-captions': 'hsl(var(--medium-emphasis))',
            '--tw-prose-invert-kbd': 'hsl(var(--high-emphasis))',
            '--tw-prose-invert-kbd-shadows': 'hsl(var(--neutral-600))',
            '--tw-prose-invert-code': 'hsl(var(--high-emphasis))',
